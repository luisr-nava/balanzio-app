...
export const TableCustomers = ({ customers, handleEdit }: Props) => {
  const [expandedRow, setExpandedRow] = useState<string | null>(null);

  return (
    <div className="overflow-hidden rounded-md border">
      <div className="hidden sm:grid grid-cols-3 bg-muted px-4 py-2 text-sm font-semibold">
        <span>Nombre</span>
          ...
          return (
            <div
              ...
              <motion.div
                ...
                className={`w-full text-left transition-colors px-4 py-3 grid grid-cols-[1fr_auto] items-center gap-3 sm:grid-cols-3 sm:items-center ${
                  isOpen ? "bg-muted/50" : ""
                }`}
                role="button"
                tabIndex={0}
